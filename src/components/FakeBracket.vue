<template>
  <div>
      ...
      <div class="container">
        <div class="split split-one">
          ...
          <div class="round round-one current">
                ...
                <!-- <ul v-for="(match, index) in matches" :key="index" class="matchup">
                    <li class="team team-top"><span v-if="match.matchId === 7">{{ match.userOneUsername }}</span><span class="score"></span></li>
                    <li class="team team-bottom"><span v-if="match.matchId === 7">{{ match.userTwoUsername }}</span><span class="score"></span></li>
                </ul> -->
            </div>END ROUND ONE
          <div class="round round-one current">
                <div cl
                ass="round-details">Round 1<br/><span class="date">March 16</span></div>
                <ul class="matchup">
                    <li class="team team-top"><span v-if="match7">{{ match7.userOneUsername }}</span><span class="score">76</span></li>
                    <li class="team team-bottom"><span v-if="match7">{{ match7.userTwoUsername }}</span><span class="score">82</span></li>
                </ul>
                <ul class="matchup">
                    <li class="team team-top"><span v-if="match6">{{ match6.userOneUsername }}</span><span class="score">64</span></li>
                    <li class="team team-bottom"><span v-if="match6">{{ match6.userTwoUsername }}</span><span class="score">56</span></li>
                </ul>
                <ul class="matchup">
                    <li class="team team-top"><span v-if="match5">{{ match5.userOneUsername }}</span><span class="score">68</span></li>
                    <li class="team team-bottom"><span v-if="match5">{{ match5.userTwoUsername }}</span><span class="score">54</span></li>
                </ul>
                <ul class="matchup">
    ...
    <div class="champion">
            <div class="semis-l">
                <div class="round-details">Semifinals <br/><span class="date">March 26-28</span></div>     
...
export default {
  ...
  data() {
    return {
      ...
      match7: {
        match: 7,
        userOneUsername: 'testing1',
        userTwoUsername: 'testing2'
      },
      match6: {
        match: 6,
        userOneUsername: 'testing3',
        userTwoUsername: 'testing4'
      },
      user: auth.getUser(), 
